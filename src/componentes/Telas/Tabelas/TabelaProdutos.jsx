...
export default function TabelaProdutos(props) {
    function excluirProdutos(produto){
        ...
        if(teste)
            excluirProduto(produto).then((resultado)=>{
                if(!resultado.status){
                                ...
                                return (
                                    ...
                                    /*style={
                                        ...
                                        <td>
                                            ...
                                            <Button  onClick={()=>{
                                                excluirProdutos(produto);}} variant="danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
