                        ...
                        props.listaDeClientes?.map((cliente) => {
                            return (
                                <tr>
                                    ...
                                    <td>{cliente.cep}</td>
                                    <td>
                                        <Button variant="warning" onClick={() => { alterarCliente(cliente) }}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
